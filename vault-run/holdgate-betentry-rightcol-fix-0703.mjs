...
const OUT = 'shots-betentry-rightcol-fix-0703';
...
async function measureLetterbox(browser, w, h, label) {
  ...
  await page.close();
  return { viewport: { w, h }, cabinet, shell, boardHeight: shell ? shell.height : null, topLetterbox, bottomLetterbox, scrollHeight, hasVScroll, innerHeight: h };
}
