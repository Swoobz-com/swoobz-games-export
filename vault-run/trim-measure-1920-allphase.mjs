...
(async () => {
  ...
  await toLobby(page); await wait(400); await measure(page, 'LOBBY@1920');
  await toBetEntry(page); await wait(400); await measure(page, 'BETENTRY@1920');
  await toPlaying(page); await wait(400); await measure(page, 'PLAYING@1920');
  await toSettled(page); await measure(page, 'SETTLED@1920');
  await browser.close();
})();
