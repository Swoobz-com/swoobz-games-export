...
(async () => {
  const browser = await puppeteer.launch({
    ...
    args: ['--window-size=1140,830'],
  });
  const page = (await browser.pages())[0];
  await page.setViewport({ width: 1120, height: 800, deviceScaleFactor: 1 });
  ...
  await page.screenshot({ path: SHOTS + 'narrow-overlap-1120-01-before-tile0-click.png' });
  ...
  await page.screenshot({ path: SHOTS + 'narrow-overlap-1120-02-after-tile0-click.png' });
