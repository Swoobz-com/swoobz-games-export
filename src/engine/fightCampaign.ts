...
export const CAMPAIGN_NODES: CampaignNodeDef[] = [
  ...
  { id: 1, name: 'KUROHAMA DOCKS', title: 'Dockmaster of Kurohama', roundsToWin: 2, multBps: 19200n, fighterId: 'volta', arenaId: 'cathedral', enemy: { id: 'sora-yari', name: 'SORA YARI' } },
  { id: 2, name: 'ASHEN TORII', title: 'Keeper of the Ashen Torii', roundsToWin: 2, multBps: 19200n, fighterId: 'volta', arenaId: 'cathedral', enemy: { id: 'kitsune-tanto', name: 'KITSUNE TANTO' } },
  { id: 3, name: 'WHISPERING BAMBOO', title: 'Blade of the Bamboo Sea', roundsToWin: 2, multBps: 19200n, fighterId: 'volta', arenaId: 'cathedral', enemy: { id: 'thorn-warden', name: 'THORN WARDEN' } },
  { id: 4, name: 'SNOWFANG PASS', title: 'Sentinel of Snowfang', roundsToWin: 2, multBps: 19200n, fighterId: 'volta', arenaId: 'cathedral', enemy: { id: 'onryo-katana', name: 'ONRYO KATANA' } },
  { id: 5, name: 'KAWA CROSSING', title: 'Duelist of the Crossing', roundsToWin: 2, defense: { kind: 'bulk', amount: 1 }, multBps: 35120n, fighterId: 'volta', arenaId: 'cathedral', enemy: { id: 'satoshi-odachi', name: 'SATOSHI ODACHI' } },
  { id: 6, name: 'HOLLOW SHRINE', title: 'Phantom of the Hollow Shrine', roundsToWin: 2, defense: { kind: 'shield', amount: 1 }, multBps: 35120n, fighterId: 'volta', arenaId: 'cathedral', enemy: { id: 'eclipse-ofuda', name: 'ECLIPSE OFUDA' } },
