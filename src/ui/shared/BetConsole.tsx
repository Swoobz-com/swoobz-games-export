/*
 * VERBATIM COPY of the shared Swoobz Originals BetConsole.
 * Source of truth: originals/_shared/BetConsole/BetConsole.tsx
 * (path relative to the swoobz-games-export monorepo root:
 *  swoobz-games-export/originals/_shared/BetConsole/BetConsole.tsx).
 *
 * Copied in (not imported across vite roots) because Frozen Requiem is a
 * self-contained vite project. Keep this file byte-identical to the shared
 * component below the header — restyle only via the BetConsoleTheme prop, never
 * by editing this file. If the shared component changes, re-copy it here.
 */
'use client'
