# ONRYO KATANA (map 4 boss) — clip kit prompts (browser Unlimited Seedance, MAGENTA anchor)

Character: onryo (vengeful ghost) samurai — pale white-grey ghostly skin, long flowing black hair,
tattered white burial kimono with ragged wispy edges, brown iron shoulder pauldron + forearm bracer,
barefoot, translucent ghostly lower body, wielding a katana wreathed in GREEN spectral flame.
Faces: right. Node 4 = NO specials. 2 takes per non-idle state. Anchor media 5d935d45.

**CHROMA = MAGENTA (Tim rule + this session):** the katana's GREEN spectral flame makes a GREEN screen
impossible (the flame IS the screen colour, unrecoverable). Body is white/grey/black/brown -> keys
clean off magenta AND the green flame separates cleanly. Keep the green flame (signature). Watch at
the KEYING phase: (a) slight green fringe on the black hair edges (green despill), (b) the ghost's
translucent/wispy robe edges are semi-transparent (soft alpha, not a hard matte).

Shared prefix:
> The EXACT SAME onryo ghost samurai from the reference image (identical pale white-grey ghostly skin,
> long flowing black hair, a tattered white burial kimono with ragged wispy edges, a brown iron
> shoulder pauldron and forearm bracer, barefoot, translucent ghostly lower body, wielding a katana
> wreathed in GREEN spectral flame), standing on a solid saturated MAGENTA chroma screen (magenta
> #a3005f, NOT pink, NOT purple, absolutely nothing green in the BACKGROUND; the green flame stays
> ONLY on his katana blade).

Shared suffix (facing lock applied proactively):
> His pale skin, black hair, tattered robe, armor and green-flamed katana stay EXACTLY the same the
> entire clip. He stays FACING SCREEN-RIGHT the entire clip and NEVER rotates or turns to face the
> camera. The camera is absolutely locked, no zoom, no pan, his full body always fully in frame, he is
> the ONLY figure in frame at all times, nothing else added. He begins and ends on the EXACT same
