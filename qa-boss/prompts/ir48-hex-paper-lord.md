# IR48 HEX PAPER LORD (map 10 — FINAL BOSS) — clip kit prompts (browser Unlimited Seedance, GREEN, faces right)
# AUTHORED DOCTRINE-NATIVE (2026-07-24): the FINALBOSS gets the most theatrical kit on the roster —
# energy verbs in the acting lines, prop-centric idle (the hex fan + paper talismans are his identity),
# locks ONLY in the suffix, wide-margin containment on every big action (the fan is LARGE — cleaves are
# kept vertical/inward, never extended off his facing side). Lore: 'Lord of the Zero Citadel'.
...
other. Faces: right (anchor faces screen-right, no flip). GREEN chroma (body is black/crimson/red — green
keys safe). Node 10 = FINAL BOSS, +3 specials. Effects: CRIMSON / GOLD / WHITE, NEVER green.
...
## idle (prop-centric energy)
IDLE COMBAT-READY LOOP: he begins in the EXACT reference pose with the war-fan raised OPEN; STAYING in
his strict side-profile stance he FANS himself once with slow contemptuous power — the paper talismans on
his hat swaying with the draft — then snaps the fan still, his sword hand slowly rotating the reversed
blade a quarter turn and back, his armored shoulders settling with a heavy exhale; then he returns to the
EXACT start pose so it loops seamlessly. Imperial, contemptuous, alive.

## strike_a (fan cleave)
STRIKE (fan cleave): he COILS back, whole body loading, then CARVES the great hex-bordered war-fan down
in one fierce vertical cleave in front of him like an executioner's blade, lifting it only to about head
height and NEVER above his head, hips and shoulders driving the cut through with real follow-through,
...
## ko (cause-free collapse, ends down)  [OFF-ANCHOR]
DEFEAT COLLAPSE: his strength leaves him — the great war-fan and the sword slip from his hands to the
ground, he sinks to one armored knee, then crumples the rest of the way down and lies motionless, his
kasa hat settling beside him, and holds there. NO blow, no impact, no opponent, only his own collapse.
He begins on the reference stance but ends collapsed on the ground, motionless, and does NOT return to
