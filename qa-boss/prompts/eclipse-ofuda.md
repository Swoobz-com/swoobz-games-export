# ECLIPSE OFUDA (map 6 boss) — clip kit prompts (browser Unlimited Seedance, GREEN anchor, FLIPPED to face right)

Character: silver-haired female ronin assassin — long silver-grey ponytail, pale skin, glowing RED eyes,
a wide woven straw conical hat (kasa) with black tassels and hanging white paper OFUDA talismans (kanji),
a black leather armored coat with heavy GOLD filigree trim over an olive undershirt, a black obi sash,
black fingerless gloves, black-and-gold armored boots, wielding a long black-and-gold katana. Faces: right
(anchor was flipped hflip so she faces screen-right like the rest of the roster). GREEN chroma (body is
black/gold/silver/pale; only a dark olive undershirt, no bright green, no pink/red on body except tiny
red eyes). Node 6 = +3 SPECIALS. 2 takes per non-idle state. Anchor media 47d2214b (flipped green).
...
Shared suffix (facing lock + BLADE-CONTAINMENT, Tim rule "sword never leaves the box on a swing"):
> Her hair, hat, ofuda talismans, armor and katana stay EXACTLY the same the entire clip. Her katana
> blade stays FULLY INSIDE the frame at ALL times and NEVER extends past any edge of the frame, even at
> the peak of a swing or raise. She stays FACING SCREEN-RIGHT the entire clip and NEVER rotates or turns
...
to the starting stance. One clean sweeping cut.

## attack_throw A  (collar grab-slam, solo-safe)
THROW (grab and slam): keeping the katana in one hand, she reaches forward with her free hand through
...
then shoves away and recovers to the starting stance. Alone, no opponent, empty air only.

## attack_block A  (katana parry into counter)
BLOCK-COUNTER: she raises the katana into a hard deflecting parry across her body, then instantly cuts
back with a short counter slash, then returns to the starting stance.

## attack_block B  (forearm deflect into rising cut)
BLOCK-COUNTER: she sweeps her forearm across in a deflecting guard to the side, then swings a short rising
katana cut, then recovers to the starting stance.

## hit  (stagger, quick recover)
HIT REACTION: her head and torso whip sharply back as she takes a blow, ponytail and talismans flaring, a
hard stagger that quickly resolves back toward her guard stance. Stays on her feet, NOT a slow topple.
Ends at the stance.

## ko  (cause-free collapse, ends on ground)
DEFEAT COLLAPSE: utterly spent, her strength leaves her, the katana drops from her grip, and she sinks to
her knees and crumples to the ground and stays down, motionless. NO blow, no impact, no opponent, only her
own collapse. Begins on the reference stance but ends collapsed on the ground and holds there (does NOT
return to standing).

## victory  (katana flourish + sheathe)
VICTORY TAUNT: she spins the katana once in a crisp flourish, snaps it down to her side in a proud stance,
then settles back to the starting stance. Alone, no opponent.
...
## special_3  (TALISMAN BIND) — effect contained in frame
