...
#   horizontal 239px spare on EACH side -> a full forward lunge is safe.
#   vertical only 88px above / 49px below -> NO jumps, NO leaps, nothing rising above the hat.
#   A deep crouch or kneel is SAFE and cheap: it makes him shorter, which GROWS the top margin.
...
## special_1 (HEX STORM — v5, BODY COMMITMENT: DRIVING LUNGE + SUSTAINED HOLD)
...
## special_2 (TALISMAN BRAND — v2, BODY COMMITMENT: SINKING CROUCH + SUSTAINED HOLD)
...
## special_3 (ZERO CITADEL EDGE — v5, SUSTAINED LUNGE HOLD + GLOWING BLADE NOT A CRESCENT)
