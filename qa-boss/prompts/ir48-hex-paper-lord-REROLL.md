...
## SUPERSEDED-special2c (TALISMAN BRAND — v3, CROUCH+DUTY SOLVED 0.260/84%, but the flare rendered as a TRANSLUCENT GAS FLAME: unkeyable on green (10.45% retention raw, washed to cream after neutralize) + TOP 200px)
...
## SUPERSEDED-special2d (TALISMAN BRAND — v4, KEYABILITY SOLVED but commitment slipped to 0.380, less than his own block)
# v3 SOLVED the body outright: minIoU 0.260 / 84% duty, up from v1r's 0.638 / 12px / 0% (which was
# statistically an IDLE). The deep sinking crouch and the sustained hold are KEPT VERBATIM.
# v3 FAILED on KEYABILITY, which is a new defect class and the reason this file now says what it
# says. The brand-flare rendered as a big TRANSLUCENT ORANGE GAS FLAME, and that cannot be keyed
# off a GREEN plate at all:
...
# Because translucent ORANGE over GREEN blends to a muddy yellow-green that is genuinely
# indistinguishable from spill. Every setting is wrong: keep the green and you ship a halo, remove
# it and you eat the effect. NOTE v3's prompt ALREADY said "thick, dense, OPAQUE ... NEVER
# see-through" and the model produced a gas flame anyway — the word OPAQUE is not enough, the
# MATERIAL has to be named.
# THE FIX, and it is better theming as well as better keying: he is the HEX PAPER LORD. The effect
# is BURNING PAPER — opaque charring talismans with hard edges, curling and blackening — NOT fire.
# Paper is an opaque MATERIAL, so it keys exactly like special_1's solid charms did (0.00% after
# neutralize, effect intact). GENERAL RULE for every remaining roster clip: specify the effect as a
# SOLID MATERIAL doing something, never as flame/glow/mist/gas.
# ALSO FIXED: v3's fire plume ran 200px off the TOP edge. Top margin is only 88px, so anything that
# rises breaks it. The burn is now capped at hat height and pushed FORWARD instead of UP.
THE VERY FIRST FRAME IS THE EXACT REFERENCE STANCE: he already stands in strict side profile with the large deep-crimson hex-bordered war-fan ALREADY FULLY OPEN AND FANNED OUT and HELD RAISED beside his chest at about head height in one hand — NOT closed, NOT folded, NOT lowered, NOT at his hip — and the short black-bladed sword held reversed at his hip in the other, matching the reference image pose EXACTLY. Both weapons stay present and clearly visible in EVERY SINGLE FRAME including the first and the last, never absent, never stowed, never appearing out of nowhere, and he RETURNS to that EXACT same raised-fan reference stance in the final frame. THERE IS NO WIND-UP OF ANY KIND: from the very first frame he moves straight into the action and NOTHING pulls back first. He NEVER coils back, NEVER rears back, NEVER draws the fan behind his shoulder, NEVER raises or draws or swings the short sword, and NEVER opens his chest toward the camera to gather himself. THE SWORD HAND DOES NOT ACT: the short black-bladed sword stays held reversed DOWN AT HIS HIP in his other hand for the ENTIRE clip, never lifted, never brandished, never swung, never pointed. SPECIAL FINISHER (talisman brand): he snatches a single white paper talisman off his own hat brim and, in the same movement, DROPS HIS WHOLE BODY STRAIGHT DOWN INTO A DEEP SINKING CROUCH — his knees bending hard, his hips sinking far down toward the ground, his whole body becoming much LOWER — and at the bottom of that drop he CLAPS the talisman flat against the face of his own war-fan and DRIVES the branded fan FORWARD and LOW, out ahead of his own chest. HE HOLDS THAT DEEP SUNKEN POSITION, low to the ground with the fan driven forward, THROUGH THE WHOLE MIDDLE OF THE CLIP, a long sustained committed hold; only at the very end does he push back up and rise to the starting stance. HE SINKS RATHER THAN REACHES: his feet stay close together under his body, he does NOT stride, does NOT split his legs wide apart and does NOT slide a foot far out behind him, and he never fills more than about two-thirds of the width of the picture. THE EFFECT IS BURNING PAPER, NOT FIRE. Dozens of SOLID PAPER TALISMAN SLIPS — real sheets of paper with hard crisp edges, deep blood-crimson faces and gold hexagon rims — CATCH and CHAR across the face of the fan and in the air just ahead of it: their edges blacken and curl, their corners crumple, and they burn away as OPAQUE SOLID SHEETS. Every single one of them is a solid opaque object you could pick up. This is NOT a flame, NOT a fire, NOT a blaze, NOT a fireball, NOT a torch, NOT a gas flame, NOT a plume, NOT smoke, NOT mist, NOT haze, NOT vapour and NOT a soft glow — there are NO see-through flame tongues, NO wispy fire edges, NO smoke trails and NO translucent orange licking anywhere in the picture. You can never see the background through any part of the effect. The paper is DEEP BLOOD-CRIMSON with GOLD hexagon rims and CHARRED BLACK curling edges from the instant it appears; it is NEVER pink, NEVER pale, NEVER cream, NEVER lavender, NEVER silver, NEVER grey and NEVER pastel, and only a brief final burst is white. THE BURN STAYS LOW AND FORWARD: every burning slip stays BELOW THE BRIM OF HIS OWN HAT at all times — nothing rises past his hat, nothing climbs upward, nothing towers over him and there is ALWAYS a BROAD band of completely empty green between the highest burning paper and the TOP edge of the picture. The burning slips gather AHEAD of his chest and around the fan, on the same side as the fan; NOTHING trails away behind his back leg and nothing gathers behind him. He keeps the talisman PINCHED IN HIS FINGERS against the fan the entire time — nothing leaves his hand, nothing floats free, nothing detaches, launches, flies or travels. There is ALWAYS a BROAD band of completely empty green between him and the LEFT edge and between him and the RIGHT edge, and NOT ONE burning slip or spark EVER reaches, touches or crosses the top, bottom, left or right edge of the picture — nothing is ever cut off by the edge of the frame. THE WAR-FAN IS ALWAYS SHOWN BROADSIDE: throughout the whole clip the fan stays FULLY OPEN, FULLY FANNED OUT and turned so that its BROAD CRIMSON FACE IS PRESENTED FLAT TO THE CAMERA, big and unmistakable, with its ribs and its full gold hexagon-cut border clearly visible; it is NEVER folded, NEVER closed, NEVER half-open, NEVER seen edge-on and NEVER a thin dark wedge. Only his fan and the forearm holding it are angled this way — his TORSO, SHOULDERS, HIPS AND HEAD stay in strict side profile the entire time. THE FAN STAYS LOW: it NEVER rises above the level of his own shoulder and NEVER goes above the brim of his hat — it goes DOWN with his body and FORWARD, nothing more. HE STAYS ON THE GROUND AND ON HIS FEET: he NEVER jumps, NEVER leaps, NEVER leaves the ground, never kneels all the way down and never lies down, and his head and hat stay WELL BELOW the top edge at every moment. HIS SHOULDERS STAY STACKED ONE BEHIND THE OTHER FOR THE WHOLE CLIP, INCLUDING THE VERY FIRST FRAMES: his near shoulder stays IN FRONT OF his far shoulder in every single frame, his chest NEVER opens or turns toward the camera even slightly, and his silhouette stays NARROW and side-on from the first frame to the last. Underneath the burning paper the war-fan stays the SAME solid DEEP CRIMSON fan with its gold hexagon-cut border and NEVER turns pale, white, grey, silver or feathered, and the short black-bladed sword stays clearly in his other hand the entire time. APART FROM HIS OWN BURNING TALISMANS THE GREEN STAYS COMPLETELY EMPTY AND UNBROKEN: the ONLY things visible anywhere in the picture, in every frame, are HIS OWN body, HIS OWN war-fan, HIS OWN short sword and HIS OWN burning paper slips. No other person, no figure, no attacker, no second weapon, no other object, no shape, no blur, no streak and no shadow ever appears in the green, and nothing ever enters the picture from outside it.

## special_2 (TALISMAN BRAND — v5, v4 EFFECT KEPT + CROUCH DEPTH FORCED)
# v4 SOLVED KEYABILITY, which was the entire point of the burning-paper rewrite:
#   raw plate retention 3.30% (v3 gas flame was 10.45%), olive 0.69% (v3 was 4.49%),
#   containment CLEAN (v3 ran TOP 200px). The burning-paper wording and the hat-height cap
#   are KEPT VERBATIM here - they work.
# v4 FAILED on commitment: minIoU 0.380 against a 0.32 bar, i.e. LESS body change than his own
# block_a (0.323). That is precisely the defect Tim raised in the first place, so it cannot ship.
# v3 reached 0.260 on the SAME crouch wording, so the loss came from the extra caps making the
# model conservative overall, not from the crouch idea being wrong.
# v5 CHANGES EXACTLY ONE CLAUSE: the crouch depth is now stated in terms measurable against his
# own body (thighs near parallel, hips near knee height, head a FULL HEAD lower, silhouette about
# half standing height) instead of the vague "sinking far down toward the ground".
THE VERY FIRST FRAME IS THE EXACT REFERENCE STANCE: he already stands in strict side profile with the large deep-crimson hex-bordered war-fan ALREADY FULLY OPEN AND FANNED OUT and HELD RAISED beside his chest at about head height in one hand — NOT closed, NOT folded, NOT lowered, NOT at his hip — and the short black-bladed sword held reversed at his hip in the other, matching the reference image pose EXACTLY. Both weapons stay present and clearly visible in EVERY SINGLE FRAME including the first and the last, never absent, never stowed, never appearing out of nowhere, and he RETURNS to that EXACT same raised-fan reference stance in the final frame. THERE IS NO WIND-UP OF ANY KIND: from the very first frame he moves straight into the action and NOTHING pulls back first. He NEVER coils back, NEVER rears back, NEVER draws the fan behind his shoulder, NEVER raises or draws or swings the short sword, and NEVER opens his chest toward the camera to gather himself. THE SWORD HAND DOES NOT ACT: the short black-bladed sword stays held reversed DOWN AT HIS HIP in his other hand for the ENTIRE clip, never lifted, never brandished, never swung, never pointed. SPECIAL FINISHER (talisman brand): he snatches a single white paper talisman off his own hat brim and, in the same movement, DROPS HIS WHOLE BODY STRAIGHT DOWN INTO AN EXTREMELY DEEP SINKING CROUCH — he sinks ALL THE WAY DOWN until his thighs are close to parallel with the ground and his hips are almost at knee height, so that his head and hat end up A FULL HEAD LOWER than where they started and his whole silhouette collapses to little more than half his standing height — and at the bottom of that drop he CLAPS the talisman flat against the face of his own war-fan and DRIVES the branded fan FORWARD and LOW, out ahead of his own chest. HE HOLDS THAT DEEP SUNKEN POSITION, low to the ground with the fan driven forward, THROUGH THE WHOLE MIDDLE OF THE CLIP, a long sustained committed hold; only at the very end does he push back up and rise to the starting stance. HE SINKS RATHER THAN REACHES: his feet stay close together under his body, he does NOT stride, does NOT split his legs wide apart and does NOT slide a foot far out behind him, and he never fills more than about two-thirds of the width of the picture. THE EFFECT IS BURNING PAPER, NOT FIRE. Dozens of SOLID PAPER TALISMAN SLIPS — real sheets of paper with hard crisp edges, deep blood-crimson faces and gold hexagon rims — CATCH and CHAR across the face of the fan and in the air just ahead of it: their edges blacken and curl, their corners crumple, and they burn away as OPAQUE SOLID SHEETS. Every single one of them is a solid opaque object you could pick up. This is NOT a flame, NOT a fire, NOT a blaze, NOT a fireball, NOT a torch, NOT a gas flame, NOT a plume, NOT smoke, NOT mist, NOT haze, NOT vapour and NOT a soft glow — there are NO see-through flame tongues, NO wispy fire edges, NO smoke trails and NO translucent orange licking anywhere in the picture. You can never see the background through any part of the effect. The paper is DEEP BLOOD-CRIMSON with GOLD hexagon rims and CHARRED BLACK curling edges from the instant it appears; it is NEVER pink, NEVER pale, NEVER cream, NEVER lavender, NEVER silver, NEVER grey and NEVER pastel, and only a brief final burst is white. THE BURN STAYS LOW AND FORWARD: every burning slip stays BELOW THE BRIM OF HIS OWN HAT at all times — nothing rises past his hat, nothing climbs upward, nothing towers over him and there is ALWAYS a BROAD band of completely empty green between the highest burning paper and the TOP edge of the picture. The burning slips gather AHEAD of his chest and around the fan, on the same side as the fan; NOTHING trails away behind his back leg and nothing gathers behind him. He keeps the talisman PINCHED IN HIS FINGERS against the fan the entire time — nothing leaves his hand, nothing floats free, nothing detaches, launches, flies or travels. There is ALWAYS a BROAD band of completely empty green between him and the LEFT edge and between him and the RIGHT edge, and NOT ONE burning slip or spark EVER reaches, touches or crosses the top, bottom, left or right edge of the picture — nothing is ever cut off by the edge of the frame. THE WAR-FAN IS ALWAYS SHOWN BROADSIDE: throughout the whole clip the fan stays FULLY OPEN, FULLY FANNED OUT and turned so that its BROAD CRIMSON FACE IS PRESENTED FLAT TO THE CAMERA, big and unmistakable, with its ribs and its full gold hexagon-cut border clearly visible; it is NEVER folded, NEVER closed, NEVER half-open, NEVER seen edge-on and NEVER a thin dark wedge. Only his fan and the forearm holding it are angled this way — his TORSO, SHOULDERS, HIPS AND HEAD stay in strict side profile the entire time. THE FAN STAYS LOW: it NEVER rises above the level of his own shoulder and NEVER goes above the brim of his hat — it goes DOWN with his body and FORWARD, nothing more. HE STAYS ON THE GROUND AND ON HIS FEET: he NEVER jumps, NEVER leaps, NEVER leaves the ground, never kneels all the way down and never lies down, and his head and hat stay WELL BELOW the top edge at every moment. HIS SHOULDERS STAY STACKED ONE BEHIND THE OTHER FOR THE WHOLE CLIP, INCLUDING THE VERY FIRST FRAMES: his near shoulder stays IN FRONT OF his far shoulder in every single frame, his chest NEVER opens or turns toward the camera even slightly, and his silhouette stays NARROW and side-on from the first frame to the last. Underneath the burning paper the war-fan stays the SAME solid DEEP CRIMSON fan with its gold hexagon-cut border and NEVER turns pale, white, grey, silver or feathered, and the short black-bladed sword stays clearly in his other hand the entire time. APART FROM HIS OWN BURNING TALISMANS THE GREEN STAYS COMPLETELY EMPTY AND UNBROKEN: the ONLY things visible anywhere in the picture, in every frame, are HIS OWN body, HIS OWN war-fan, HIS OWN short sword and HIS OWN burning paper slips. No other person, no figure, no attacker, no second weapon, no other object, no shape, no blur, no streak and no shadow ever appears in the green, and nothing ever enters the picture from outside it.
