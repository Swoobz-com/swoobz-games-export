...
// Tap 5 DISTINCT tiles (46px apart) within the visible scroller viewport
for (let i = 0; i < 5; i++) {
  await page.touchscreen.tap(box.x + 20 + i*47, box.y + 20)
  await new Promise(r=>setTimeout(r,90))
}
const readOdo = () => page.evaluate(() => {
...
console.log('odometer after 5 distinct taps:', await readOdo())
// A real pan/drag should NOT add a stray 6th tile
await page.touchscreen.touchStart(box.x + 200, box.y + 200)
await page.touchscreen.touchMove(box.x + 100, box.y + 100)
await page.touchscreen.touchEnd()
await new Promise(r=>setTimeout(r,150))
console.log('odometer after pan (should be unchanged):', await readOdo())
await browser.close()
