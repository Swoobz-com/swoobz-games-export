...
const OUT = 'C:/Users/Erstr/OneDrive/Bureaublad/swoobz-games-export/swoobz-games-export/assay-run/shots-touchqa-deepcurrent-0704'
...
const headerOneLineCheck = () => page.evaluate(() => {
  // Find PLAY SAFE button and any BALANCE/session text near the header row.
  ...
  // Walk up to find the flex row parent and check its height vs single-line expectation.
...
for (const d of devices) {
  ...
  // ── MAX-TRAIL=100 via discrete real taps across successive scrolled pages ──
  ...
  // Real touch tap on the BreakerLever to plunge.
