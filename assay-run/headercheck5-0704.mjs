...
await wait(400)
console.log('phase after enter:', (await page.evaluate(()=>document.body.innerText)).slice(0,200))
...
console.log('breaker box:', bpos)
if (bpos) await page.touchscreen.tap(bpos.x, bpos.y)
await wait(1200)
console.log('phase after breaker tap:', (await page.evaluate(()=>document.body.innerText)).slice(0,300))
await wait(1000)
console.log('phase after wait more:', (await page.evaluate(()=>document.body.innerText)).slice(0,300))
await browser.close()
